...
bool configHasKey(std::string key, const std::vector<std::string>& iniLines);
bool configHasTaggedKey(std::string tag, std::string key, const std::vector<std::string>& sectionLines);
bool getStringValueForTaggedKey(std::string tag, std::string key, std::string& value, const std::vector<std::string>& sectionLines);
bool getStringValueForKey(std::string key, std::string& value, const std::vector<std::string>& sectionLines);
bool getIntValueForTaggedKey(std::string tag, std::string key, int& value, const std::vector<std::string>& sectionLines);
bool getIntValueForKey(std::string key, int& value, const std::vector<std::string>& sectionLines);
