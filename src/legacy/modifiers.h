...
constexpr uint32_t BITMASK_LCTRL   = 0x002;
constexpr uint32_t BITMASK_LWIN    = 0x004;
constexpr uint32_t BITMASK_LALT    = 0x008;
constexpr uint32_t BITMASK_RSHIFT  = 0x010;
constexpr uint32_t BITMASK_RCTRL   = 0x020;
constexpr uint32_t BITMASK_RWIN    = 0x040;
constexpr uint32_t BITMASK_RALT    = 0x080;
constexpr uint32_t BITMASK_MOD9    = 0x100;
constexpr uint32_t BITMASK_MOD10   = 0x200;
constexpr uint32_t BITMASK_MOD11   = 0x400;
constexpr uint32_t BITMASK_MOD12   = 0x800;
constexpr uint32_t BITMASK_MOD13   = 0x1000;
constexpr uint32_t BITMASK_MOD14   = 0x2000;
constexpr uint32_t BITMASK_MOD15   = 0x4000;
constexpr uint32_t BITMASK_MOD16   = 0x8000;
constexpr uint32_t BITMASK_MOD17   = 0x10000;
constexpr uint32_t BITMASK_MOD18   = 0x20000;
constexpr uint32_t BITMASK_MOD19   = 0x40000;
constexpr uint32_t BITMASK_MOD20   = 0x80000;
constexpr uint32_t BITMASK_MOD21   = 0x100000;
constexpr uint32_t BITMASK_MOD22   = 0x200000;
constexpr uint32_t BITMASK_MOD23   = 0x400000;
constexpr uint32_t BITMASK_MOD24   = 0x800000;
constexpr uint32_t BITMASK_MOD25   = 0x1000000;
constexpr uint32_t BITMASK_MOD26   = 0x2000000;
constexpr uint32_t BITMASK_MOD27   = 0x4000000;
constexpr uint32_t BITMASK_MOD28   = 0x8000000;
constexpr uint32_t BITMASK_MOD29   = 0x10000000;
constexpr uint32_t BITMASK_MOD30   = 0x20000000;
constexpr uint32_t BITMASK_MOD31   = 0x40000000;
constexpr uint32_t BITMASK_MOD32   = 0x80000000;
